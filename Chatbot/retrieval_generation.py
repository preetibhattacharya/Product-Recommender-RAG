...
gboq_api_key = os.getenv("GBOQ_API")  # .env should have GBOQ_API=<your_key>
if not gboq_api_key:
    raise ValueError("GBOQ_API not set. Please add it to your .env file or environment variables.")

model = ChatGroq(api_key=gboq_api_key, model="llama-3.3-70b-versatile", temperature=0.5)
store = {}
